...
SAVE_DIR = "C:/Users/itsak/OneDrive/Desktop/ML/Melody Generation/temps"
SINGLE_FILE_DATASET = "file_datase"
MAPPING_PATH = "mappin.json"
SEQUENCE_LENGTH = 64
...
def load_songs_in_kern(dataset_path):
    ...
    """
    songs = []
    song = m21.converter.parse('C:/Users/itsak/OneDrive/Desktop/ML/Melody Generation/tests.krn')
    print(song)
    #song=m21.midi.translate.midiFileToStream(song)
    songs.append(song)
    print(song.flat.notesAndRests)
    return songs
